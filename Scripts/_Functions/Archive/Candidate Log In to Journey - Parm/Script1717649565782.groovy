...
WebUI.setText(findTestObject('Object Repository/temp/input_Username_log'), GlobalVariable.username)

WebUI.setText(findTestObject('Object Repository/temp/input_Password_pwd'), GlobalVariable.password)
