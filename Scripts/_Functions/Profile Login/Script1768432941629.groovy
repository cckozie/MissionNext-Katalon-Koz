...
if(varProfile != '') {
	...
	spaceOne = varProfile.indexOf(' ')
	
	spaceTwo = varProfile.lastIndexOf(' ')
	
	site = varProfile[0..varProfile.indexOf(' ') - 1]
	
	println(site)
	
	type = varProfile[spaceOne + 1 ..spaceTwo - 1]
...
WebUI.setText(findTestObject('Object Repository/' + site + ' ' + type + ' Profile/Login/input_Username'), username)

//WebUI.setEncryptedText(findTestObject('Object Repository/' + site + ' Candidate Profile/Login/input_Password'), password)
WebUI.setEncryptedText(findTestObject('Object Repository/' + site + ' ' + type + ' Profile/Login/input_Password'), password)
