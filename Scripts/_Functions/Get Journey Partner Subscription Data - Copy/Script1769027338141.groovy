...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Admin/Ad Subscription Utility/select_Website'), 'Journey', false)
...
if (row_count > 0) {
    for (row = 1; row < row_count; row++) {
		...
		values.addAll(organization, start, expires)
