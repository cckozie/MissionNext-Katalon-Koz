...
WebUI.setEncryptedText(findTestObject('Object Repository/Journey Partner Profile/Login/input_Password'), GlobalVariable.password)

WebUI.click(findTestObject('Object Repository/Journey Partner Profile/Login/button_Log In'))
