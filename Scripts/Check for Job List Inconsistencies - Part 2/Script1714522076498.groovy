...
new File('/Users/cckozie/Documents/MissionNext/Summary_Category_Map.txt').withWriter({ def out ->
...
new File('/Users/cckozie/Documents/MissionNext/Detail_Category_Description.txt').withWriter({ def out ->
