...
maxMatches = 10 //overridden if test suite running
...
outFile = new File(('/Users/cckozie/Documents/MissionNext/Test Reports/Matching Details/' + myTestCase + ' Partner-' + user) + '.txt')

resultsFile = new File(('/Users/cckozie/Documents/MissionNext/Test Reports/' + myTestCase + ' Partner-' + user) + '-results.txt')

resultsFile.write(('Running ' + myTestCase) + '\n')

errorFile = new File(('/Users/cckozie/Documents/MissionNext/Test Reports/Matching Details/' + myTestCase + ' Partner-' + user) + '-ERRORS.txt')

errorFile.write('Running ' + myTestCase + ' - Listing Errors Only\n')

if(debug) {
	debugFile = new File(('/Users/cckozie/Documents/MissionNext/Test Reports/Matching Details/' + myTestCase + ' Partner-' + user) + '-DEBUG.txt')
...
WebUI.click(findTestObject('Object Repository/Journey Partner Profile/Matching/a_Matching Category 2 old'))
