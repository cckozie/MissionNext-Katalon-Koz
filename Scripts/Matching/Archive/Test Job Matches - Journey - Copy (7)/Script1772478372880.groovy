...
outFile = new File(('/Users/cckozie/Documents/MissionNext/Test Reports/Matching Details/' + myTestCase + ' Partner-' + user + '-Job#' + testJob) + '.txt')

resultsFile = new File(('/Users/cckozie/Documents/MissionNext/Test Reports/' + myTestCase + ' Partner-' + user + '-Job#' + testJob) + '-results.txt')

resultsFile.write(('Running ' + myTestCase) + '\n')

errorFile = new File(('/Users/cckozie/Documents/MissionNext/Test Reports/Matching Details/' + myTestCase + ' Partner-' + user + '-Job#' + testJob) + '-ERRORS.txt')

errorFile.write('Running ' + myTestCase + ' - Listing Errors Only\n')

if(debug) {
	debugFile = new File(('/Users/cckozie/Documents/MissionNext/Test Reports/Matching Details/' + myTestCase + ' Partner-' + user + '-Job#' + testJob) + '-DEBUG.txt')
...
WebUI.click(findTestObject('Object Repository/Journey Partner Profile/Matching/button_Matches ' + testJob))
