...
WebUI.callTestCase(findTestCase('Admin/Archive/Switch-To Username - Sikuli'), [('varUsername') : user, ('varSite') : site], FailureHandling.STOP_ON_FAILURE)
