...
/* ##### Problem of Organization job selection = null when it should not be

 * Candidate Selections for Rich Wickline
 * For SUPPORT HELPS
   Job selections = [Administrative Assistant, Data Entry, Job Classification]
   
   For Ministry Preferences
   Job selections = null
Candidate selections = [Administrative Assistant,
 */
