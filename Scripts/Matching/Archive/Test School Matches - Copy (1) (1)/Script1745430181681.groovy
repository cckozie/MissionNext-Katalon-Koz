...
candWildcardsEO = [('I/We can be Available') : 'Not sure', ('Time Commitment(s)') : 'Open - Will negotiate', ('Relocation Option(s)') : 'Not sure'
...
def doMatching(candidateSelections, organizationSelections) {
	...
	resultsFile.append('Match percentages: Calculated = ' + points.round(0).toInteger() + ' %, Table = '  + tblPct + ' %, Popup = '  + popupPct + '.\n')
