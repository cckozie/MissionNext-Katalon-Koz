...
//WOrking on Schools
varMatchType = 'Organization'

varMatchSite = 'Education'
...
if (varMatchType == 'Organization') {
    link = 'a_Candidate Matches'
}

if (varMatchType == 'Jobs') {
...
if (!(bypass)) {
    ...
    if (varMatchType == 'Jobs') {
        ...
        s.click(imagePath + 'What Matched Jobs.png')
    } else {
...
dataFile = (filePath + 'Candidates for Match Testing - ' + varMatchType + '.csv')
