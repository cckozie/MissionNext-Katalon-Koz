...
WebUI.verifyElementVisible(findTestObject('Education Partner Profile/Register/div_Username message'))

msg = 'Username must be at least 6 characters long, no spaces, lowercase letters and numbers only, no special or unique characters.'

userMsg = WebUI.getText(findTestObject('Education Partner Profile/Register/div_Username message'))

if(userMsg != msg) {
	
	outText = '----- Username message is "' + userMsg + '", but should be "' + msg + '".'
...
WebUI.verifyElementVisible(findTestObject('Education Partner Profile/Register/div_Password message'))

msg = 'Password must have at least 10 characters; should include numbers, letters, and capitals; \
	may have special characters (@, #, *, spaces, etc.) and may include a passphrase.'

userMsg = WebUI.getText(findTestObject('Education Partner Profile/Register/div_Password message'))

if(userMsg != msg) {
	
	errorMessage('Password', userMsg, msg)
	
}
System.exit(1)
WebUI.verifyElementVisible(findTestObject('Education Partner Profile/Register/div_Email message'))

pswMsg = WebUI.getText(findTestObject('Education Partner Profile/Register/div_Password message'))
...
WebUI.verifyElementVisible(findTestObject('Education Partner Profile/Register/div_First name message'))

firstNameMsg = WebUI.getText(findTestObject('Education Partner Profile/Register/div_First name message'))
...
WebUI.verifyElementVisible(findTestObject('Education Partner Profile/Register/div_Last name message'))

WebUI.verifyElementVisible(findTestObject('Education Partner Profile/Register/div_Organization name message'))

WebUI.verifyElementVisible(findTestObject('Education Partner Profile/Register/div_Description message'))

WebUI.verifyElementVisible(findTestObject('Education Partner Profile/Register/div_Website address message'))

WebUI.verifyElementVisible(findTestObject('Education Partner Profile/Register/div_School qualifications message'))

WebUI.verifyElementVisible(findTestObject('Education Partner Profile/Register/div_Partner agreement message'))

WebUI.verifyElementVisible(findTestObject('Education Partner Profile/Register/div_Terms and conditions message'))
...
def errorMessage(field, displayed, shouldBe) {
	
	outText = '----- ' + field + ' message is:\n"' + displayed + '"\n,     but it should be \n"' + shouldBe + '"'
