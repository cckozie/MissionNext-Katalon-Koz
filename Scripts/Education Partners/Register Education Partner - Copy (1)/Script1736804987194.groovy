...
fieldMessages = [('Username message') : 'Username must be at least 6 characters long, no spaces, lowercase letters and numbers only, no special or unique characters.'
    , ('Password message') : 'Password must have at least 10 characters; should include numbers, letters, and capitals; may have special characters (@, #, *, spaces, etc.) and may include a passphrase.'
    , ('Email message') : 'Please enter a valid email address.', ('First name message') : 'The First Name field is required.'
    , ('Last name message') : 'The last name field is required.', ('Organization name message') : 'The organization name field is required.'
    , ('Description message') : 'The description field is required.', ('Website address message') : 'The website address field is required.'
    , ('School qualifications message') : 'The meet qualifications for christian school field is required.', ('Partner agreement message') : 'The partner agreement field is required.'
