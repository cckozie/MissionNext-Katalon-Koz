...
//	Move the input field data out of the script and into the profile GlobalVariables
...
firstName = GlobalVariable.username //'Chris TEST EP'
...
WebUI.setEncryptedText(findTestObject('Education Partner Profile/Register/input_Password'), password)
