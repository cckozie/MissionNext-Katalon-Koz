...
// Set output file
testName = 'Journey Affiliate Contact Info Tab'
...
tooltipImagePath = '/Users/cckozie/git/MissionNext-Katalon-Koz/images/Journey Affiliate/tabs/contact information/'
...
WebUI.click(findTestObject('Journey Affiliate/Tabs/a_Contact Information'))
...
if (varMailing_address != null) {
    object = 'Object Repository/Journey Affiliate/Tabs/Contact Info/textarea_Mailing Address'
...
myClass = WebUI.getAttribute(findTestObject('Journey Affiliate/a_Contact Information'), 'class', FailureHandling.OPTIONAL)
