...
home = JOptionPane.showInputDialog(frame, 'Wait while preparing for selenium and sikulix funtions')
...
WebUI.setText(findTestObject('Journey Profile/Register/input_Email'), GlobalVariable.username)
