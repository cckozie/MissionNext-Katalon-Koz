...
//TestObject tObj = findTestObject('Journey Candidate Profile/Tab-Contact Info/input_First Name')

myObject = 'Journey Profile/Contact Info tab/input_Gender_Male'

//TestObject tObj = findTestObject('Journey Candidate Profile/Tab-Contact Info/radio_Gender_Male')
...
TestObject testObjectAttribute = findTestObject('Journey Candidate Profile/Tab-Contact Info/radio_Gender_Female')
