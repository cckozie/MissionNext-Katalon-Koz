...
//TestObject tObj = findTestObject('Journey Candidate Profile/Tabs/Contact Info/input_First Name')

myObject = 'Journey Profile/Contact Info tab/input_Gender_Male'

//TestObject tObj = findTestObject('Journey Candidate Profile/Tabs/Contact Info/radio_Male')
...
TestObject testObjectAttribute = findTestObject('Journey Candidate Profile/Tabs/Contact Info/radio_Female')
