...
tooltipTextMap = WebUI.callTestCase(findTestCase('_Functions/Get Screenshot and Tooltip Text'), [('varExtension') : 'Service Options Tab'], FailureHandling.STOP_ON_FAILURE)
