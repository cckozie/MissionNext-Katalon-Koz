...
tooltips = [
('dummy') : 'dummy',
('Spouse Additional Language(s)') : 'img_Spouse Additional Language(s)_field-tooltip']

// Define the expected tooltip texts
tooltipText = [
('Spouse Additional Language(s)') : 'Other language in which you have some level of fluency.']

// Define the required field missing error message test objects
requiredFieldMsgs = [
('Spouse Previous Experience') : 'The spouse teaching experience field is required.']
...
if (varSpouse_credential_authority != null) {
	...
	WebUI.callTestCase(findTestCase('_Functions/Perform Action'), [('varAction'): 'setText',
		('varObject') : object, ('varParm1') : varSpouse_credential_authority], FailureHandling.STOP_ON_FAILURE)
}
...
if (varSpouse_other_experience != null) {
	...
	WebUI.callTestCase(findTestCase('_Functions/Perform Action'), [('varAction'): 'setText',
		('varObject') : object, ('varParm1') : varSpouse_other_experience], FailureHandling.STOP_ON_FAILURE)
}
...
if (varSpouse_english_proficiency != null) {
	...
	WebUI.callTestCase(findTestCase('_Functions/Perform Action'), [('varAction'): 'selectOptionByValue',
		('varObject') : object, ('varParm1') : varSpouse_english_proficiency], FailureHandling.STOP_ON_FAILURE)
}
...
if (varSpouse_additional_languages != null) {
	...
	WebUI.callTestCase(findTestCase('_Functions/Perform Action'), [('varAction'): 'setText',
		('varObject') : object, ('varParm1') : varSpouse_additional_languages], FailureHandling.STOP_ON_FAILURE)
}
