...
partnerUser = 'joshua.r@jesusfilm.org' //'joshua.r@jesusfilm.org' //Partner from whom we captured jobs (Set the Profile to the user to receive the jobs)
