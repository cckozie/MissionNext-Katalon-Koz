...
jobFilesPath = '/Users/cckozie/git/MissionNext-Katalon-Koz/Data Files/Jobs/'
...
myJobFile.write('Definition for ' + jobCategory + '_' + jobTitle + '\n')

myJobFile.append('Category:' + jobCategory + '\n')

myJobFile.append('Title:' + jobTitle + '\n')
