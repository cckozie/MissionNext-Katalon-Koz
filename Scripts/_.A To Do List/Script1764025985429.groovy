...
//	MATCHING SELECTIONS IN OTHER CRITERIA
// 	NON-MATCHING SELECTIONS IN OTHER CRITERIA
//	VARIOUS SPOUSE SELECTIONS FOR PREFERRED POSITIONS
...
//
// ** COMPLETED 10/30/25 Force the contact and email fields to be me when running Create Parner Jobs
//
...
//
// Create script to test partner view vs candidate view of job matches. Use ckteester@missionnext.org and joshua.r@jesusfilm.org
