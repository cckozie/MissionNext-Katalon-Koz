...
dataFile = new File('/Users/cckozie/Documents/MissionNext/Test Data/' + myTestCase + ' Subscription List_' + now + '.csv')

editsFile = new File('/Users/cckozie/Documents/MissionNext/Test Data/' + myTestCase + 'Subscription Edits_' + now + '.csv')
    ...
    if ((loginYear != 2019) && ((expireYear != endYear) || (md != mmdd))) {
        ...
        if (!(printOnly)) {
            ...
            for (editRow = 1; editRow < edit_row_count; editRow++) {
				...
				WebUI.takeFullPageScreenshot(imagePath + username + '_before.png')
