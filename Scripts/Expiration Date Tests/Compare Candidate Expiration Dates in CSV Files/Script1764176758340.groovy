...
if(nowFile == '?') {
	outText = '\n##################################################\n'
	outText += "YOU MUST RUN SCRIPT 'Test Candidate Expiration Dates' with options for 'All' and 'errorsOnly = false' to get the current list.\n"
	outText += '##################################################'
...
outText = 'Run Date,User ID,Username,Email,First Name,Last Name,Last Login,End Date,Calculated,Errors'

if(ignore2026) {
	outText = outText + ', IGNORING RECORDS WITH LAST LOGIN IN 2026'
}
