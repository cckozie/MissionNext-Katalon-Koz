...
outFile = new File('/Users/cckozie/Documents/MissionNext/Test Reports/ExploreNext URL Test.txt')

outFile.write('Testing ExploreNext URL\'s\n')
...
def checkForBypass(def link) {
    ...
    if (link.indexOf('missionnext.org') > 0) {
        skip = true

        outText = (('missionnext.org was found in the link ' + link) + ' on page myKey.\n')
