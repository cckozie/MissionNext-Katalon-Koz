...
//			WebUI.click(waitForElementClickable('Page_Journey missionary-jobs-detail - MissionNext.org/a_Category_Parm', [('category') : category]),10)
			WebUI.click(findTestObject('Misc Saved Objects/Page_Journey missionary-jobs-detail - MissionNext.org/a_Category_Parm', [('category') : category]))
//			WebUI.click(findTestObject('Misc Saved Objects/Page_Journey missionary-jobs-detail - MissionNext.org/a_Category_Parm', [('category') : "BUSINESS AS MISSION"]))
//			WebUI.click(findTestObject('Page_tCC translationNotes/columns_Parmed', [('column') : 'ID']))
			
			WebUI.waitForElementPresent(findTestObject('Misc Saved Objects/Page_Journey missionary-jobs-detail - MissionNext.org/a_Back to Category List'),
				60, FailureHandling.STOP_ON_FAILURE)

			category_jobs = []

			String job_list = WebUI.getText(findTestObject('Misc Saved Objects/Page_Journey missionary-jobs-detail - MissionNext.org/div_Current Category Jobs'))
			...
			WebUI.click(findTestObject('Misc Saved Objects/Page_Journey missionary-jobs-detail - MissionNext.org/a_Back to Category List'))

			WebUI.waitForElementClickable(findTestObject('Misc Saved Objects/Page_Journey missionary-jobs-detail - MissionNext.org/a_View Job Summary List'),
				30)
		}
