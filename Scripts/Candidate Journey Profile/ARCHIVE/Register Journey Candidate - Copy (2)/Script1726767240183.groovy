...
if(GlobalVariable.username != 'cktest05jc') {
...
WebUI.setText(findTestObject('Journey Candidate Profile/Journey Register/input_Username'), username)

WebUI.setText(findTestObject('Journey Candidate Profile/Journey Register/input_Email'), email)

WebUI.setEncryptedText(findTestObject('Journey Candidate Profile/Journey Register/input_Password'), password)
...
WebUI.setText(findTestObject('Journey Candidate Profile/Journey Register/input_First Name'), username)
...
if (GlobalVariable.gender == 'Male') {
    WebUI.click(findTestObject('Object Repository/Journey Candidate Profile/Tab-Contact Info/radio_Gender_Male'))
} else {
    WebUI.click(findTestObject('Object Repository/Journey Candidate Profile/Tab-Contact Info/radio_Gender_Female'))
}

WebUI.selectOptionByValue(findTestObject('Object Repository/Journey Candidate Profile/Tab-Contact Info/select_State'), GlobalVariable.state, 
    false)

WebUI.setText(findTestObject('Object Repository/Journey Candidate Profile/Tab-Contact Info/input_Birth_Year'), GlobalVariable.birth_year)

WebUI.click(findTestObject('Object Repository/Journey Candidate Profile/Tab-Contact Info/btn_Submit'))
