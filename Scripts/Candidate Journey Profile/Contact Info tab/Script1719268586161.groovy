...
WebUI.setText(findTestObject('Journey Profile/Contact Info Tab/input_First Name'), '')

WebUI.setText(findTestObject('Journey Profile/Contact Info Tab/input_Last Name'), '')

WebUI.setText(findTestObject('Journey Profile/Contact Info Tab/input_Email'), 'cckozie@gmail.com')

WebUI.click(findTestObject('Journey Profile/Contact Info Tab/input_btn_Submit'))
