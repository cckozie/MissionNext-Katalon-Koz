...
for(site in sites) {
	if('Connecting' in menus) {
//		retValue = WebUI.callTestCase(findTestCase('MissionWorks Headers and Footers/Functions/Archive/Connecting Menu'), [('varSite') : site.key, ('varUrl') : site.value], FailureHandling.OPTIONAL)
		retValue = WebUI.callTestCase(findTestCase('MissionWorks Headers and Footers/Functions/Consolidated Menu Test'), [('varSite') : site.key, ('varUrl') : site.value, ('varMenu') : 'Connecting'], FailureHandling.OPTIONAL)
	...
	if('Equipping' in menus) {
//		retValue = WebUI.callTestCase(findTestCase('MissionWorks Headers and Footers/Functions/Archive/Equipping Menu'), [('varSite') : site.key, ('varUrl') : site.value], FailureHandling.OPTIONAL)
		retValue = WebUI.callTestCase(findTestCase('MissionWorks Headers and Footers/Functions/Consolidated Menu Test'), [('varSite') : site.key, ('varUrl') : site.value, ('varMenu') : 'Equipping'], FailureHandling.OPTIONAL)
...
//		retValue = WebUI.callTestCase(findTestCase('MissionWorks Headers and Footers/Functions/About Us Menu'), [('varSite') : site.key, ('varUrl') : site.value], FailureHandling.OPTIONAL)
		retValue = WebUI.callTestCase(findTestCase('MissionWorks Headers and Footers/Functions/Consolidated Menu Test'), [('varSite') : site.key, ('varUrl') : site.value, ('varMenu') : 'About Us'], FailureHandling.OPTIONAL)
...
def testMWLogo(site) {
	...
	WebUI.click(findTestObject('Object Repository/MissionWorks Headers and Footers/Header/img_MissionWorks logo'))
...
def testDonate(site) {
	...
	exists = WebUI.verifyElementPresent(findTestObject('Object Repository/MissionWorks Headers and Footers/Header/a_Donate'), 1, FailureHandling.OPTIONAL)
	
	if(exists) {
	
		clickAble = WebUI.verifyElementClickable(findTestObject('Object Repository/MissionWorks Headers and Footers/Header/a_Donate'), FailureHandling.OPTIONAL)
		
		if(clickAble) {
	
			WebUI.click(findTestObject('Object Repository/MissionWorks Headers and Footers/Header/a_Donate'))
...
def testFooter(site) {
	...
	defaultFooterSites = ['Journey', 'Education', 'QuickStart', 'Journey Guide', 'MissionLinked', 'Coaching', 'About Us']
...
if(compare) { //THIS IS NOT WORKING BECAUSE DIFFMERGE DOES NOT TOLERATE SPACES IN THE COMMAND
	/*
	list = []
	
	filePart = 'Test_MissionWorks_Headers_and_Footers_on_missionnext.org'
//	filePart = 'Test MissionWorks Headers-Footers on missionnext.org'
	...
	for(file in list) {
		...
		if(myFile.contains(filePart) && myFile.contains('-ALL') && myFile.contains('.txt')) {
			files.add(myFile)
		}
	}
	...
	command = "/Applications/DiffMerge.app/Contents/Resources/diffmerge.sh"
