...
menus = ['Connecting' : ['MissionConnexion', 'MissionNext','MissionGuide'], 'Equipping' : ['Coaching', 'MissionLinked','MissionArmor', 'MissionExcellence']]
...
pageTitles = ['Homepage - MissionConnexion', 'Serve in Missions - MissionNext.org', 'Short Term Mission Trips | International and Domestic',
	'Journey Guides - MissionNext.org', 'MissionLinked – MissionWorks', 'MissionArmor – MissionWorks', 'MissionExcellence']
