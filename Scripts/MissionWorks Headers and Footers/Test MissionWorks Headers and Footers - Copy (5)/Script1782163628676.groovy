...
donateTest = false //true

footerTest = false //true
...
def testForHeaderFooter(testObjects, folderBase) {
...
def testMenus(site, url, menu) {
	...
	for(option in menuOptions) {
		...
		if(first) {
			...
			folder = testForHeaderFooter(testObject, folderBase)
			...
			if(folder == null) {
				...
				if(exists) {
					...
					WebUI.mouseOver(findTestObject('MissionWorks Headers and Footers/Header/img_MissionWorks logo'))
