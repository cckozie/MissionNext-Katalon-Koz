...
WebUI.setText(findTestObject('Journey Candidate Profile/Register/input_Username'), username)

WebUI.setText(findTestObject('Journey Candidate Profile/Register/input_Email'), email)

WebUI.setEncryptedText(findTestObject('Journey Candidate Profile/Register/input_Password'), password)
...
WebUI.setText(findTestObject('Journey Candidate Profile/Register/input_First Name'), username)
...
if (GlobalVariable.gender == 'Male') {
    WebUI.click(findTestObject('Object Repository/Journey Candidate Profile/Tabs/Contact Info/radio_Male'))
} else {
    WebUI.click(findTestObject('Object Repository/Journey Candidate Profile/Tabs/Contact Info/radio_Female'))
}

WebUI.selectOptionByValue(findTestObject('Object Repository/Journey Candidate Profile/Tabs/Contact Info/select_State'), GlobalVariable.state, 
    false)

WebUI.setText(findTestObject('Object Repository/Journey Candidate Profile/Tabs/Contact Info/input_Birth Year'), GlobalVariable.birth_year)

WebUI.click(findTestObject('Object Repository/Journey Candidate Profile/Tabs/Contact Info/btn_Submit'))
