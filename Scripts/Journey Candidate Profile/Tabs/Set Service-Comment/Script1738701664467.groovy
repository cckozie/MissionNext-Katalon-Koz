...
tooltipTextMap = WebUI.callTestCase(findTestCase('_Functions/Get Screenshot and Tooltip Text'), [('varExtension') : 'Service-Comment Tab'], FailureHandling.STOP_ON_FAILURE)
