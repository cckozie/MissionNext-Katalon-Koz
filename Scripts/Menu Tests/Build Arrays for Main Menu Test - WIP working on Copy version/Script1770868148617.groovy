...
"journey.missionnext.org|https://journey.missionnext.org/missionnext.org/about/",
"journey.missionnext.org|https://journey.missionnext.org/missionnext.org/about/positions-with-missionnext/",
"journey.missionnext.org|https://journey.missionnext.org/missionnext.org/category/impact-report/",
"journey.missionnext.org|https://journey.missionnext.org/missionnext.org/goer/",
"journey.missionnext.org|https://journey.missionnext.org/missionnext.org/sender/",
...
"journey.missionnext.org|https://missionnext.org/homepage/about/missionnext-strategic-partners/",
...
//"journey.missionnext.org|https://missionnext/about/missionnext-strategic-partners/",
"journey.missionnext.org|https://missionnext.org/about/missionnext-strategic-partners/",
//"journey.missionnext.org|https://missionnextv.org/sender/sender-churches/",
...
"missionnext.org|https://journey.missionnext.org/managerlogin/?action=logout&redirect_to=http://journey.missionnext.org&_wpnonce=ffa470f58d",
...
"quickstart.missionnext.org|https://education.missionnext.org/education-home/im-a-school/",
...
"quickstart.missionnext.org|https://journey.missionnext.org/journey-home/im-an-organization/",
...
titleMap = [	//Format is HOME PAGE URL | LINKED TO URL : LINKED PAGE TITLE
	...
	"quickstart.missionnext.org|https://education.missionnext.org/education-home/im-a-school/" : "I'm a School - Education",
	...
	"quickstart.missionnext.org|https://journey.missionnext.org/journey-home/im-an-organization/" : "I'm an Organization - Journey",
...
if(function == 'get links') {
	...
	for(page in startPages) {
		...
		elements.each {
			...
			if(href != null && href.contains('//missionnext/')) {
				println('****** ERROR on href ' + href)
				System.exit(0)
			}
...
if(function == 'get titles') {
	...
	outFile = new File('/Users/cckozie/Documents/MissionNext/Test Reports/Homepage Links.csv')
	
	outFile.write('Start page,From URL,To URL,Page Title, Error\n')
...
//	homePageLinks.each {
	for(it in homePageLinks) {
		...
		if(!first) {
			outFile.append(homePage + ',' + url + ',' + link + ',' )
		}
		...
		messageExists = WebUI.verifyTextPresent('There has been a critical error on this website.', false, FailureHandling.OPTIONAL)
		
		if(messageExists) {
		
			WebElement message = driver.findElement(By.xpath('//*[@id="content"]/div/div/p[1]'));
