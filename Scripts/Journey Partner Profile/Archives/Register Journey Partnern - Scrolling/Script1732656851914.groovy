...
yOffset = 150 //Offset of elemnent's y location to which to scroll for element interactions
...
fieldMessages = [('div_Username message') : 'Username must be at least 6 characters long, no spaces, lowercase letters and numbers only, no special or unique characters.'
    ...
    , ('div_Email message') : 'Please enter a valid email address.', ('div_Organization name message') : 'The organization name field is required.'
    , ('div_First name message') : 'The First Name field is required.', ('div_Last name message') : 'The last name field is required.'
    , ('div_Phone message') : 'The key contact phone field is required.', ('div_Address message') : 'The mailing address field is required.'
    , ('div_City message') : 'The city field is required.', ('div_State message') : 'The state field is required.', ('div_Postal code message') : 'The post code field is required.'
    , ('div_Description message') : 'The description field is required.', ('div_Url message') : 'The website address field is required.'
    , ('div_Memberships message') : 'The memberships field is required.', ('div_Mission statement message') : 'The mission statement field is required.'
    , ('div_BOD message') : 'The board of directors field is required.', ('div_SoF message') : 'The statement of faith field is required.'
    , ('div_References message') : 'The references field is required.', ('div_Partner agreement message') : 'The partner agreement field is required.'
...
tooltips.each({ 
        ...
        if (f.exists()) {
            ...
            if (found != null) {
                ...
                pct = foundStr.substring(matchP + 1, matchP + 5)

                outText = ('+++++++++++++++ Found tooltip text for ' + myKey)

                println(outText)

                outText = ('Match value is ' + pct + '% for ' + myKey)
...
pageLinks.each({ 
        ...
        tObj = ('Object Repository/Journey Partner Profile/Register/' + myElement)
...
fieldMessages.each({ 
        ...
        tObj = ('Journey Partner Profile/Register/' + myObj)
        ...
        if (myObj == 'div_Email message') {
            ...
            tObj = 'Journey Partner Profile/Register/input_Username'

            setText(tObj, GlobalVariable.username)

            tObj = 'Journey Partner Profile/Register/input_Password'

            setEncryptedText(tObj, GlobalVariable.password)

            tObj = 'Journey Partner Profile/Register/input_Key Contact Email'

            setText(tObj, GlobalVariable.email)

            tObj = 'Journey Partner Profile/Register/button_Sign up'
...
setText('Journey Partner Profile/Register/input_Key Contact Title', GlobalVariable.title)

setText('Journey Partner Profile/Register/input_Key Contact First Name', GlobalVariable.first_name)

setText('Journey Partner Profile/Register/input_Key Contact Last Name', GlobalVariable.last_name)

setText('Journey Partner Profile/Register/input_Key Contact Email', GlobalVariable.email)

setText('Journey Partner Profile/Register/input_Key Contact Phone', GlobalVariable.phone_number)

selectOptionByValue('Journey Partner Profile/Register/select_Tier Level', GlobalVariable.tier, false)
...
setText('Journey Partner Profile/Register/input_Website Address', website)
...
for (def org : orgs) {
    ...
    click('Journey Partner Profile/Register/' + myObject)
}

setText('Journey Partner Profile/Register/input_Mission Statement', GlobalVariable.mission_statement)

setText('Journey Partner Profile/Register/input_Board of Directors', GlobalVariable.bod)
...
setText('Journey Partner Profile/Register/textarea_Referral or Other Comment', GlobalVariable.referral)

click('Journey Partner Profile/Register/checkbox_Partnership Agreement')

click('Journey Partner Profile/Register/checkbox_Terms and Conditions')

click('Journey Partner Profile/Register/button_Sign up')
