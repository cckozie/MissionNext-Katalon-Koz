...
profiles = [
	'Education Candidate 14' : ['My Profile', 'View Job Matches', 'Search School Jobs', 'View School Matches', 'Search Schools', 'Job Inquiry List', 'Logout'],
	'Education Partner 16' : ['My Profile', 'Educator Matches', 'Search Educators', 'My Favorites', 'Job Matches', 'Job Inquiry List'],
	'Journey Candidate 15' : ['My Profile', 'View Job Matches', 'Search Agency Jobs', 'View Agency Matches', 'Search Agencies', 'My Favorites', 'Job Inquiry List', 'Logout'],
	'Journey Partner 17' : [],
	'QuickStart Candidate 02' : []
	]

genericDashboardLinks = ['My Profile', 'Job Inquiry List', 'Logout']
...
for(profile in profiles) {
	...
	for(link in profile.value) {
		...
		if(link.contains('View')) {
		...
		} else if(link == 'Search School Jobs' || link == 'Search Agency Jobs') {
			...
			returnToDashboard()
/*			
			if(profile.key.contains('Education')) {
