...
outFile = new File(('/Users/cckozie/Documents/MissionNext/Test Reports/Test Register QuickStart Candidate on ' + domain) + 
'.txt')

GlobalVariable.outFile = outFile

outFile.write(('Testing Register QuickStart Candidate on ' + domain) + '.\n')
...
tooltips = [('dummy') : 'dummy', ('Username') : 'img_Username_field-tooltip', ('Email') : 'img_Email_field-tooltip', ('Password') : 'img_Password_field-tooltip'
    , ('First Name') : 'img_First Name_field-tooltip', ('Last Name') : 'img_Last Name_field-tooltip', ('Age Bracket') : 'img_Age Bracket-tooltip'
	, ('Job Categories') : 'img_Job Categories-tooltip', ('Terms and Conditions') : 'img_Terms and Conditions_field-tooltip']
...
pageLinks = [('ministry positions') : 'Preferred-Position.pdf', ('Privacy Policy') : 'Privacy Policy', ('Terms and Conditions') : 'Terms and Conditions', ]
...
requiredFieldMsgs = [('Username') : 'Username must be unique; at least 6 characters; contain only lowercase letters; allowable characters: numbers, @, dash, underscore or period, and can be an email address.'
	...
	, ('Zip') : 'The zip field is required.', ('Age Bracket') : 'The age bracket field is required.'
    , ('Country') : 'The country field is required.', ('Job Categories') : 'The job categories field is required.', ('Terms and Conditions') : 'The terms and conditions field is required.']
...
object = 'QuickStart Candidate Profile/Register/button_Sign up'
...
object = 'Object Repository/QuickStart Candidate Profile/Register/button_Sign up'
WebUI.callTestCase(findTestCase('_Functions/Perform Action'), [('varAction'): 'click', ('varObject') : object], FailureHandling.STOP_ON_FAILURE)
