...
WebUI.click(findTestObject('QuickStart Candidate Profile/Tabs/a_Contact Info'))
/*
...
// Set the Country
if (varComments != null) {
	object = 'Object Repository/QuickStart Candidate Profile/Tabs/Contact Info/select_Country'
	parm1 = varCountry
...
// Set the Comments
if (varComments != null) {
	object = 'Object Repository/QuickStart Candidate Profile/Tabs/Contact Info/textarea_Comments'
	parm1 = varComments
...
myClass = WebUI.getAttribute(findTestObject('QuickStart Candidate Profile/Tabs/a_Contact Info'), 'class', FailureHandling.OPTIONAL)
