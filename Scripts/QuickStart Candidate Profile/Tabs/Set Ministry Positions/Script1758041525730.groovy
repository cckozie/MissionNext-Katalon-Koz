...
job_categories = '//*[@id="profile_group-1599136931.246_job_categories"]'

//xpath of the Preferred Positions group 
preferred_positions = '//*[@id="profile_group-1599136931.246_ministry_preferences"]'
...
testObjectFolder = 'QuickStart Candidate Profile/Tabs/Ministry Positions/'
...
requiredFieldMsgs = [
//('Job Categories') : 'The job categories field is required.',	//Some categories are selected during the registration
...
profile = WebUI.verifyElementVisible(findTestObject('QuickStart Candidate Profile/Tabs/a_Contact Info'), FailureHandling.OPTIONAL)
